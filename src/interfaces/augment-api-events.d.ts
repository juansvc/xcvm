...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        assetsRegistry: {
            ...
            AssetUpdated: AugmentedEvent<ApiType, [assetId: u128, location: ComposableTraitsXcmAssetsXcmAssetLocation], {
                assetId: u128;
                location: ComposableTraitsXcmAssetsXcmAssetLocation;
            }>;
            MinFeeUpdated: AugmentedEvent<ApiType, [targetParachainId: u32, foreignAssetId: ComposableTraitsXcmAssetsXcmAssetLocation, amount: Option<u128>], {
        ...
        bondedFinance: {
             ...
             **/
            NewBond: AugmentedEvent<ApiType, [offerId: u128, who: AccountId32, nbOfBonds: u128], {
                offerId: u128;
                who: AccountId32;
                nbOfBonds: u128;
            }>;
             ...
             **/
            NewOffer: AugmentedEvent<ApiType, [offerId: u128], {
                offerId: u128;
            }>;
            /**
        ...
        callFilter: {
             ...
             * Paused transaction
             **/
            Disabled: AugmentedEvent<ApiType, [entry: ComposableTraitsCallFilterCallFilterEntry], {
                entry: ComposableTraitsCallFilterCallFilterEntry;
            }>;
            /**
             * Unpaused transaction
             **/
            Enabled: AugmentedEvent<ApiType, [entry: ComposableTraitsCallFilterCallFilterEntry], {
                entry: ComposableTraitsCallFilterCallFilterEntry;
            }>;
            /**
             * Generic event
        ...
        crowdloanRewards: {
            Associated: AugmentedEvent<ApiType, [remoteAccount: PalletCrowdloanRewardsModelsRemoteAccount, rewardAccount: AccountId32], {
                remoteAccount: PalletCrowdloanRewardsModelsRemoteAccount;
                rewardAccount: AccountId32;
            }>;
            Claimed: AugmentedEvent<ApiType, [remoteAccount: PalletCrowdloanRewardsModelsRemoteAccount, rewardAccount: AccountId32, amount: u128], {
                remoteAccount: PalletCrowdloanRewardsModelsRemoteAccount;
                rewardAccount: AccountId32;
                amount: u128;
            }>;
        ...
        dexRouter: {
            RouteAdded: AugmentedEvent<ApiType, [xAssetId: u128, yAssetId: u128, route: Vec<u128>], {
                xAssetId: u128;
                yAssetId: u128;
                route: Vec<u128>;
            }>;
            RouteDeleted: AugmentedEvent<ApiType, [xAssetId: u128, yAssetId: u128, route: Vec<u128>], {
                xAssetId: u128;
                yAssetId: u128;
                route: Vec<u128>;
            }>;
            RouteUpdated: AugmentedEvent<ApiType, [xAssetId: u128, yAssetId: u128, oldRoute: Vec<u128>, updatedRoute: Vec<u128>], {
                xAssetId: u128;
                yAssetId: u128;
                oldRoute: Vec<u128>;
        ...
        dutchAuction: {
            CofigurationAdded: AugmentedEvent<ApiType, [configurationId: u128, configuration: ComposableTraitsTimeTimeReleaseFunction], {
                configurationId: u128;
                configuration: ComposableTraitsTimeTimeReleaseFunction;
            }>;
            OrderAdded: AugmentedEvent<ApiType, [orderId: u128, order: PalletDutchAuctionSellOrder], {
                orderId: u128;
        ...
        ibc: {
             ...
             * Ibc errors
             **/
            IbcErrors: AugmentedEvent<ApiType, [errors: Vec<PalletIbcErrorsIbcError>], {
                errors: Vec<PalletIbcErrorsIbcError>;
            }>;
            /**
             * Raw Ibc events
             **/
            IbcEvents: AugmentedEvent<ApiType, [events: Vec<PalletIbcEventsIbcEvent>], {
        ...
        ibcPing: {
             ...
             **/
            ChannelOpened: AugmentedEvent<ApiType, [channelId: Bytes, portId: Bytes], {
                channelId: Bytes;
                portId: Bytes;
            }>;
            /**
        ...
        lending: {
             ...
             **/
            Borrowed: AugmentedEvent<ApiType, [sender: AccountId32, marketId: u32, amount: u128], {
                sender: AccountId32;
                marketId: u32;
                amount: u128;
            }>;
             ...
             **/
            BorrowRepaid: AugmentedEvent<ApiType, [sender: AccountId32, marketId: u32, beneficiary: AccountId32, amount: u128], {
                sender: AccountId32;
                marketId: u32;
             ...
             **/
            CollateralDeposited: AugmentedEvent<ApiType, [sender: AccountId32, marketId: u32, amount: u128], {
                sender: AccountId32;
                marketId: u32;
                amount: u128;
            }>;
             ...
             **/
            CollateralWithdrawn: AugmentedEvent<ApiType, [sender: AccountId32, marketId: u32, amount: u128], {
                sender: AccountId32;
                marketId: u32;
                amount: u128;
            }>;
             ...
             **/
            LiquidationInitiated: AugmentedEvent<ApiType, [marketId: u32, borrowers: Vec<AccountId32>], {
                marketId: u32;
             ...
             **/
            MarketCreated: AugmentedEvent<ApiType, [marketId: u32, vaultId: u64, manager: AccountId32, currencyPair: ComposableTraitsDefiCurrencyPairCurrencyId], {
                marketId: u32;
                vaultId: u64;
                manager: AccountId32;
                currencyPair: ComposableTraitsDefiCurrencyPairCurrencyId;
            }>;
            MarketUpdated: AugmentedEvent<ApiType, [marketId: u32, input: ComposableTraitsLendingUpdateInput], {
                marketId: u32;
             ...
             **/
            MayGoUnderCollateralizedSoon: AugmentedEvent<ApiType, [marketId: u32, account: AccountId32], {
                marketId: u32;
                account: AccountId32;
            }>;
            /**
        ...
        mosaic: {
             ...
             **/
            AssetMappingCreated: AugmentedEvent<ApiType, [assetId: u128, networkId: u32, remoteAssetId: CommonMosaicRemoteAssetId], {
                assetId: u128;
                networkId: u32;
             ...
             **/
            AssetMappingDeleted: AugmentedEvent<ApiType, [assetId: u128, networkId: u32, remoteAssetId: CommonMosaicRemoteAssetId], {
                assetId: u128;
                networkId: u32;
                remoteAssetId: CommonMosaicRemoteAssetId;
            }>;
             ...
             **/
            AssetMappingUpdated: AugmentedEvent<ApiType, [assetId: u128, networkId: u32, remoteAssetId: CommonMosaicRemoteAssetId], {
                assetId: u128;
                networkId: u32;
                remoteAssetId: CommonMosaicRemoteAssetId;
            }>;
            BudgetUpdated: AugmentedEvent<ApiType, [assetId: u128, amount: u128, decay: PalletMosaicDecayBudgetPenaltyDecayer], {
                assetId: u128;
                amount: u128;
             ...
             **/
            NetworksUpdated: AugmentedEvent<ApiType, [networkId: u32, networkInfo: PalletMosaicNetworkInfo], {
                networkId: u32;
             ...
             **/
            PartialTransferAccepted: AugmentedEvent<ApiType, [from: AccountId32, assetId: u128, networkId: u32, remoteAssetId: CommonMosaicRemoteAssetId, amount: u128], {
                from: AccountId32;
                assetId: u128;
                networkId: u32;
                remoteAssetId: CommonMosaicRemoteAssetId;
             ...
             **/
            StaleTxClaimed: AugmentedEvent<ApiType, [to: AccountId32, by: AccountId32, assetId: u128, amount: u128], {
                to: AccountId32;
                by: AccountId32;
                assetId: u128;
                amount: u128;
             ...
             **/
            TransferClaimed: AugmentedEvent<ApiType, [by: AccountId32, to: AccountId32, assetId: u128, amount: u128], {
                by: AccountId32;
                to: AccountId32;
                assetId: u128;
                amount: u128;
             ...
             **/
            TransferInto: AugmentedEvent<ApiType, [id: H256, to: AccountId32, networkId: u32, remoteAssetId: CommonMosaicRemoteAssetId, assetId: u128, amount: u128], {
                id: H256;
                to: AccountId32;
                networkId: u32;
                remoteAssetId: CommonMosaicRemoteAssetId;
             ...
             **/
            TransferIntoRescined: AugmentedEvent<ApiType, [account: AccountId32, amount: u128, assetId: u128], {
                account: AccountId32;
                amount: u128;
                assetId: u128;
            }>;
             ...
             **/
            TransferOut: AugmentedEvent<ApiType, [id: H256, to: ComposableSupportEthereumAddress, assetId: u128, networkId: u32, remoteAssetId: CommonMosaicRemoteAssetId, amount: u128], {
                id: H256;
        ...
        pablo: {
             ...
             **/
            LiquidityAdded: AugmentedEvent<ApiType, [who: AccountId32, poolId: u128, baseAmount: u128, quoteAmount: u128, mintedLp: u128], {
                who: AccountId32;
                poolId: u128;
                baseAmount: u128;
                quoteAmount: u128;
             ...
             **/
            LiquidityRemoved: AugmentedEvent<ApiType, [who: AccountId32, poolId: u128, baseAmount: u128, quoteAmount: u128, totalIssuance: u128], {
                who: AccountId32;
                poolId: u128;
                baseAmount: u128;
                quoteAmount: u128;
             ...
             **/
            PoolCreated: AugmentedEvent<ApiType, [poolId: u128, owner: AccountId32, assets: ComposableTraitsDefiCurrencyPairCurrencyId], {
                poolId: u128;
                owner: AccountId32;
             ...
             **/
            PoolDeleted: AugmentedEvent<ApiType, [poolId: u128, baseAmount: u128, quoteAmount: u128], {
                poolId: u128;
                baseAmount: u128;
                quoteAmount: u128;
            }>;
             ...
             **/
            Swapped: AugmentedEvent<ApiType, [poolId: u128, who: AccountId32, baseAsset: u128, quoteAsset: u128, baseAmount: u128, quoteAmount: u128, fee: ComposableTraitsDexFee], {
                poolId: u128;
                who: AccountId32;
                baseAsset: u128;
                quoteAsset: u128;
        ...
        proxy: {
             ...
             **/
            AnonymousCreated: AugmentedEvent<ApiType, [anonymous: AccountId32, who: AccountId32, proxyType: Null, disambiguationIndex: u16], {
             ...
             * A proxy was added.
             **/
            ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: Null, delay: u32], {
             ...
             * A proxy was removed.
             **/
            ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: Null, delay: u32], {
                delegator: AccountId32;
                delegatee: AccountId32;
                proxyType: Null;
                delay: u32;
        ...
        tokens: {
             ...
             * A balance was set by root.
             **/
            BalanceSet: AugmentedEvent<ApiType, [currencyId: u128, who: AccountId32, free: u128, reserved: u128], {
                currencyId: u128;
                who: AccountId32;
                free: u128;
                reserved: u128;
             ...
             **/
            Deposited: AugmentedEvent<ApiType, [currencyId: u128, who: AccountId32, amount: u128], {
                currencyId: u128;
                who: AccountId32;
                amount: u128;
            }>;
             ...
             **/
            DustLost: AugmentedEvent<ApiType, [currencyId: u128, who: AccountId32, amount: u128], {
                currencyId: u128;
                who: AccountId32;
                amount: u128;
            }>;
             ...
             * An account was created with some free balance.
             **/
            Endowed: AugmentedEvent<ApiType, [currencyId: u128, who: AccountId32, amount: u128], {
                currencyId: u128;
                who: AccountId32;
                amount: u128;
            }>;
             ...
             **/
            LockRemoved: AugmentedEvent<ApiType, [lockId: U8aFixed, currencyId: u128, who: AccountId32], {
                lockId: U8aFixed;
                currencyId: u128;
                who: AccountId32;
            }>;
             ...
             **/
            LockSet: AugmentedEvent<ApiType, [lockId: U8aFixed, currencyId: u128, who: AccountId32, amount: u128], {
                lockId: U8aFixed;
                currencyId: u128;
                who: AccountId32;
                amount: u128;
             ...
             * Some balance was reserved (moved from free to reserved).
             **/
            Reserved: AugmentedEvent<ApiType, [currencyId: u128, who: AccountId32, amount: u128], {
                currencyId: u128;
                who: AccountId32;
                amount: u128;
            }>;
             ...
             * another account).
             **/
            ReserveRepatriated: AugmentedEvent<ApiType, [currencyId: u128, from: AccountId32, to: AccountId32, amount: u128, status: FrameSupportTokensMiscBalanceStatus], {
                currencyId: u128;
                from: AccountId32;
                to: AccountId32;
                amount: u128;
             ...
             **/
            Slashed: AugmentedEvent<ApiType, [currencyId: u128, who: AccountId32, freeAmount: u128, reservedAmount: u128], {
                currencyId: u128;
                who: AccountId32;
                freeAmount: u128;
                reservedAmount: u128;
             ...
             * Transfer succeeded.
             **/
            Transfer: AugmentedEvent<ApiType, [currencyId: u128, from: AccountId32, to: AccountId32, amount: u128], {
                currencyId: u128;
                from: AccountId32;
                to: AccountId32;
                amount: u128;
             ...
             * Some balance was unreserved (moved from reserved to free).
             **/
            Unreserved: AugmentedEvent<ApiType, [currencyId: u128, who: AccountId32, amount: u128], {
                currencyId: u128;
                who: AccountId32;
                amount: u128;
            }>;
             ...
             **/
            Withdrawn: AugmentedEvent<ApiType, [currencyId: u128, who: AccountId32, amount: u128], {
                currencyId: u128;
                who: AccountId32;
                amount: u128;
            }>;
        ...
        vault: {
             ...
             **/
            Deposited: AugmentedEvent<ApiType, [account: AccountId32, assetAmount: u128, lpAmount: u128], {
                account: AccountId32;
                assetAmount: u128;
                lpAmount: u128;
            }>;
            ...
            LiquidateStrategy: AugmentedEvent<ApiType, [account: AccountId32, amount: u128], {
                account: AccountId32;
                amount: u128;
            }>;
            /**
             ...
             **/
            Withdrawn: AugmentedEvent<ApiType, [account: AccountId32, lpAmount: u128, assetAmount: u128], {
                account: AccountId32;
                lpAmount: u128;
                assetAmount: u128;
            }>;
        ...
        vesting: {
             ...
             **/
            Claimed: AugmentedEvent<ApiType, [who: AccountId32, asset: u128, lockedAmount: u128], {
                who: AccountId32;
                asset: u128;
                lockedAmount: u128;
            }>;
             ...
             **/
            VestingScheduleAdded: AugmentedEvent<ApiType, [from: AccountId32, to: AccountId32, asset: u128, schedule: ComposableTraitsVestingVestingSchedule], {
                from: AccountId32;
                to: AccountId32;
                asset: u128;
