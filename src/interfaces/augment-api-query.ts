...
import type { ComposableTraitsXcmCumulusMethodId } from '@/interfaces/common';
...
import type { PalletPabloPoolConfiguration, PalletPabloPriceCumulative, PalletPabloTimeWeightedAveragePrice } from '@/interfaces/pablo';
