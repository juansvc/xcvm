import type { Asset } from '@composable/interfaces/assets';
import type { CustomRpcBalance, CustomRpcCurrencyId } from '@composable/interfaces/common';
import type { PalletPabloPoolId, PalletPabloPriceAggregate } from '@composable/interfaces/pablo';
