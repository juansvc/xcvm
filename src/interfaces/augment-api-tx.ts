...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    xcvm: {
      execute: AugmentedSubmittable<(realOrigin: Option<AccountId32> | null | object | string | Uint8Array, salt: Bytes | string | Uint8Array, funds: XcvmCoreAssetXcvmTransfer, program: XcvmCoreProgramXcvmProgram | { tag?: any; instructions?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<AccountId32>, Bytes, XcvmCoreAssetXcvmTransfer, XcvmCoreProgramXcvmProgram]>;
      executeJson: AugmentedSubmittable<(realOrigin: Option<AccountId32> | null | object | string | Uint8Array, salt: Bytes | string | Uint8Array, funds: XcvmCoreAssetXcvmTransfer, program: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<AccountId32>, Bytes, XcvmCoreAssetXcvmTransfer, Bytes]>;
      executeProtobuf: AugmentedSubmittable<(realOrigin: Option<AccountId32> | null | object | string | Uint8Array, salt: Bytes | string | Uint8Array, funds: XcvmCoreAssetXcvmTransfer, program: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<AccountId32>, Bytes, XcvmCoreAssetXcvmTransfer, Bytes]>;
